...
interface PgColumnToBuilderOverrides<TData = unknown> {
  name?: string;
  notNull?: boolean;
  primaryKey?: boolean;
  default?: TData | SQL | undefined;
...
declare class PgClonedColumnBuilder extends PgColumnBuilder {
  static readonly [entityKind]: string;
  private readonly ColumnClass;
