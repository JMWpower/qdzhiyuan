...
var NodeCockroachPreparedQuery = class extends CockroachPreparedQuery {
	...
	async execute(placeholderValues = {}) {
		return tracer.startActiveSpan("drizzle.execute", async () => {
			...
			const { fields, rawQueryConfig: rawQuery, client, queryConfig: query, nullableObjectPaths, customResultMapper } = this;
			...
			return tracer.startActiveSpan("drizzle.mapResponse", () => {
				...
				return (this.rowMapper ??= this.useJitMappers ? makeJitQueryMapper(fields, nullableObjectPaths) : makeDefaultQueryMapper(fields, nullableObjectPaths))(result.rows);
			});
		});
	}
