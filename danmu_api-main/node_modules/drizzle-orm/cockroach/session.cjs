	...
	async execute(placeholderValues = {}) {
		return __tracing_ts.tracer.startActiveSpan("drizzle.execute", async () => {
			...
			return __tracing_ts.tracer.startActiveSpan("drizzle.mapResponse", () => {
				...
				return (this.rowMapper ??= this.useJitMappers ? (0, __utils_ts.makeJitQueryMapper)(fields, nullableObjectPaths) : (0, __utils_ts.makeDefaultQueryMapper)(fields, nullableObjectPaths))(result.rows);
			});
		});
	}
